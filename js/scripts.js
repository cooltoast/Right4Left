...
$(function () {
  if ($("#navigation ul li").hasClass("current")) $(this).addClass("navhover");
});
    ...
    jQuery.ajax({
      ...
      success: function (r) {
        if (r == 1) {
          ...
          $("h1").after(
            '<p id="success" style="display:none;">Your message was sent successfully! We will contact you as soon as possible. </p>',
          );
